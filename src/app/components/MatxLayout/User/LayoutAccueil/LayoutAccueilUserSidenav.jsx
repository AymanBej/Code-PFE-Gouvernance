...
const LayoutAccueilUserSidenav = () => {
  const theme = useTheme();
  const { settings, updateSettings } = useSettings();
  const leftSidebar = settings.layoutAccueilUserSettings.leftSidebar;
  ...
  //   updateSettings({ layoutAccueilUserSettings: { leftSidebar: { ...sidebarSettings } } });
  // };
...
export default memo(LayoutAccueilUserSidenav);
