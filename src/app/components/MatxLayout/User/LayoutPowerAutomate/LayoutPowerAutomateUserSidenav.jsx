...
const LayoutPowerAutomateUserSidenav = () => {
  const theme = useTheme();
  const { settings, updateSettings } = useSettings();
  const leftSidebar = settings.layoutPowerAutomateUserSettings.leftSidebar;
  ...
  //   updateSettings({ layoutPowerAutomateUserSettings: { leftSidebar: { ...sidebarSettings } } });
  // };
...
export default memo(LayoutPowerAutomateUserSidenav);
