...
const LayoutTeamsUserSidenav = () => {
  const theme = useTheme();
  const { settings, updateSettings } = useSettings();
  const leftSidebar = settings.layoutTeamsUserSettings.leftSidebar;
  ...
  //   updateSettings({ layoutTeamsUserSettings: { leftSidebar: { ...sidebarSettings } } });
  // };
...
export default memo(LayoutTeamsUserSidenav);
