...
const LayoutExchangeAdminSidenav = () => {
  const theme = useTheme();
  const { settings, updateSettings } = useSettings();
  const leftSidebar = settings.layoutExchangeAdminSettings.leftSidebar;
  ...
  //   updateSettings({ layoutExchangeAdminSettings: { leftSidebar: { ...sidebarSettings } } });
  // };
...
export default memo(LayoutExchangeAdminSidenav);
