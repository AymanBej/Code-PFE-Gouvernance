...
const LayoutPowerAutomateAdminSidenav = () => {
  const theme = useTheme();
  const { settings, updateSettings } = useSettings();
  const leftSidebar = settings.layoutPowerAutomateAdminSettings.leftSidebar;
  ...
  //   updateSettings({ layoutPowerAutomateAdminSettings: { leftSidebar: { ...sidebarSettings } } });
  // };
...
export default memo(LayoutPowerAutomateAdminSidenav);
