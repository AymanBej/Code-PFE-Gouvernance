...
const LayoutTeamsAdminSidenav = () => {
  const theme = useTheme();
  const { settings, updateSettings } = useSettings();
  const leftSidebar = settings.layoutTeamsAdminSettings.leftSidebar;
  ...
  //   updateSettings({ layoutTeamsAdminSettings: { leftSidebar: { ...sidebarSettings } } });
  // };
...
export default memo(LayoutTeamsAdminSidenav);
