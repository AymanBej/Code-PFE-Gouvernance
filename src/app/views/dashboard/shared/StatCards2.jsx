    ...
    <Grid container spacing={3} sx={{ mb: 3 }}>
      <Grid item xs={12} md={6}>
        <Card elevation={3} sx={{ p: 2 }}>
          <ContentBox>
            <FabIcon style={{zIndex:"1"}} size="medium" sx={{ background: "rgba(9, 182, 109, 0.15)" }}>
              <TrendingUp color="success" />
            </FabIcon>

            <H3 color="#08ad6c">Utilisateurs actifs</H3>
          </ContentBox>
      ...
      <Grid item xs={12} md={6}>
        <Card elevation={3} sx={{ p: 2 }}>
          <ContentBox>
            ...
            <H3 color="error.main">Moyenne d'utilisation par jour</H3>
          </ContentBox>
